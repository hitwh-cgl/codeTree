        ...
        public int myAtoi(String s) {
            ...
            for (int i = 0; i < s.length(); i++) {
                ...
                if (cur - '0' >= 0 && cur - '0' <= 9) {
                    ...
                    // value*10 + cur-'0' > Integer.MAX_VALUE;
                    // value*10 + curValue + Integer.MIN_VALUE > 0;
                    int curValue = cur - '0';
                    if (!negative && (value > (Integer.MAX_VALUE - curValue) / 10)) {
                        return Integer.MAX_VALUE;
                    }
                    if (negative && (-value < (Integer.MIN_VALUE + curValue) / 10)) {
