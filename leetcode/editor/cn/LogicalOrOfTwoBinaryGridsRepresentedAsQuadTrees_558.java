...
public class LogicalOrOfTwoBinaryGridsRepresentedAsQuadTrees_558 {
    ...
    static class Solution {
        public Node intersect(Node quadTree1, Node quadTree2) {
            ...
            if (quadTree1.isLeaf) {
                ...
                return mergeLeaf(quadTree1);
            } else {
                quadTree2.topLeft = intersect(quadTree1.topLeft, quadTree2.topLeft);
                quadTree2.topRight = intersect(quadTree1.topRight, quadTree2.topRight);
                quadTree2.bottomLeft = intersect(quadTree1.bottomLeft, quadTree2.bottomLeft);
                quadTree2.bottomRight = intersect(quadTree1.bottomRight, quadTree2.bottomRight);
                return mergeLeaf(quadTree2);
            }
        }

        private Node mergeLeaf(Node cur) {
